(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("royplayer"));
	else if(typeof define === 'function' && define.amd)
		define(["royplayer"], factory);
	else if(typeof exports === 'object')
		exports["royplayer-m4a"] = factory(require("royplayer"));
	else
		root["royplayer-m4a"] = factory(root["royplayer"]);
...
var _royplayer = __webpack_require__(13);

var _royplayer2 = _interopRequireDefault(_royplayer);
...
var m4aplayer = function m4aplayer() {
  var player = this;var sniffer = _royplayer2.default.sniffer;var util = _royplayer2.default.util;
  var Errors = _royplayer2.default.Errors;var mainURL = void 0;var backupURL = void 0;
  var preloadTime = player.config.preloadTime || 15;
  var waiterTimer = void 0;
  _royplayer2.default.m4a = true;
  ...
  if (['chrome', 'firfox', 'safari'].some(function (item) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        mp4.once('mdatReady', function () {
          ...
          mp4.seek(start).then(function (buffer) {
            if (buffer) {
              var meta = _royplayer2.default.util.deepCopy({
    ...
    // let playBtn = util.findDom(player.root, '.royplayer-play');
...
_royplayer2.default.install('m4aplayer', m4aplayer);
...
var MP4 = function () {
  ...
  _createClass(MP4, [{
    ...
    value: function moovParse() {
      ...
      if (_royplayer2.default.util.typeOf(traks) !== 'Array') {
        traks = [traks];
      }
...
_buildTree(SubBox, ['box\\tfhd'], _tfhd2.default);

_buildTree(SubBox, ['box\\tkhd'], _tkhd2.default);

_buildTree(SubBox, ['box\\traf'], _traf2.default);

_buildTree(SubBox, ['box\\trun'], _trun2.default);
...
module.exports = JSON.parse("{\"name\":\"royplayer-m4a\",\"version\":\"0.0.4\",\"description\":\"royplayer plugin for m4a transform to fmp4\",\"main\":\"./dist/index.js\",\"scripts\":{\"prepare\":\"npm run build\",\"build\":\"webpack --progress --display-chunks -p\",\"watch\":\"webpack --progress --display-chunks -p --watch\"},\"repository\":{\"type\":\"git\",\"url\":\"git@github.com:littleants707/royplayer.git\"},\"babel\":{\"presets\":[\"es2015\"],\"plugins\":[\"add-module-exports\",\"babel-plugin-bulk-import\"]},\"keywords\":[\"mp4\",\"fmp4\",\"player\",\"audio\"],\"author\":\"295446101@qq.com\",\"license\":\"MIT\",\"dependencies\":{\"concat-typed-array\":\"^1.0.2\",\"deepmerge\":\"^2.0.1\",\"event-emitter\":\"^0.3.5\"},\"peerDependency\":{\"royplayer\":\"^0.1.0\"},\"devDependencies\":{\"babel-core\":\"^6.26.3\",\"babel-loader\":\"^7.1.4\",\"babel-plugin-add-module-exports\":\"^0.2.1\",\"babel-plugin-bulk-import\":\"^1.0.2\",\"babel-preset-es2015\":\"^6.24.1\",\"json-loader\":\"^0.5.7\",\"webpack\":\"^4.11.0\"}}");
