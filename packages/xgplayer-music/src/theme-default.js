...
const defaultTheme = function (player) {
  ...
  util.addClass(player.root, 'royplayer-music-default')
  ...
  const backward = util.createDom('xg-backward', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
            <path transform = "scale(1.5 1.5) translate(8 4.5)"
            d="m 14,2.99996 0,10 -7,-5 7,-5 z m -7,5 0,5 -7,-5 7,-5 0,5 z m -7,0 0,0 z"></path>
        </svg></xg-icon>`, {}, 'royplayer-backward')
  ...
  const prev = util.createDom('xg-prev', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
            <path transform = "scale(0.025 0.025)"
            d="M600 1140v-768h128v352l320-320v704l-320-320v352zz"></path>
        </svg></xg-icon>`, {}, 'royplayer-prev')
  ...
  const next = util.createDom('xg-next', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
            <path transform="scale(0.025 0.025)"
            d="M800 380v768h-128v-352l-320 320v-704l320 320v-352z"></path>
        </svg></xg-icon>`, {}, 'royplayer-next')
  ...
  const forward = util.createDom('xg-forward', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
            <path transform = "scale(1.5 1.5) translate(-2 4.5)"
            d="m 2,2.99996 0,10 7,-5 -7,-5 z m 7,5 0,5 7,-5 -7,-5 0,5 z m 7,0 0,0 z"></path>
        </svg></xg-icon>`, {}, 'royplayer-forward')
  ...
  const poster = util.createDom('xg-poster', `<img src="${player.config.poster || player.config.url[0].poster}">`, {}, 'royplayer-poster')
