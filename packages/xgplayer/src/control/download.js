...
const download = function () {
  ...
  let downloadEl = util.createDom('royplayer-download', `<xg-icon class="royplayer-download-img"></xg-icon>`, {}, 'royplayer-download')
  ...
  let tips = util.createDom('xg-tips', tipsDownload, {}, 'royplayer-tips')
