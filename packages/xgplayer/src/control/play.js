...
let play = function () {
  ...
  if (playBtn.type === 'img') {
    ...
    btn = util.createDom('xg-play', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
              <path transform="scale(${scale} ${scale})" d="${iconPath.play}"></path>
          </svg></xg-icon>`, {}, 'royplayer-play')
  ...
  let tips = util.createDom('xg-tips', tipsPlay, {}, 'royplayer-tips')
