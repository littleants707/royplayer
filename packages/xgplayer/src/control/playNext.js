...
const playNext = function () {
  ...
  if (nextBtn && nextBtn.urlList) {
    ...
    if (nextBtn.type === 'img') {
      ...
      next = util.createDom('xg-playNext', `<xg-icon class="royplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                <path transform="scale(0.025 0.025)"
                d="M800 380v768h-128v-352l-320 320v-704l320 320v-352z"></path>
            </svg></xg-icon>`, {}, 'royplayer-playNext')
    }
