...
const rotate = function () {
  ...
  let btn = util.createDom('xg-rotate', '<xg-icon class="royplayer-icon royplayer-rotate-img"></xg-icon>', {}, 'royplayer-rotate')
  let tipsRotate = player.config.lang && player.config.lang === 'zh-cn' ? '旋转' : 'Rotate'
  let tips = util.createDom('xg-tips', tipsRotate, {}, 'royplayer-tips')
