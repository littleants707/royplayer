...
let volume = function () {
  ...
  if (sniffer.device === 'mobile') {
    ...
    let container = util.createDom('xg-volume', `<xg-icon class="royplayer-icon">
    ...
    let icon = container.querySelector('.royplayer-icon')
  ...
  let container = util.createDom('xg-volume', `<xg-icon class="royplayer-icon">
                                                ...
                                                <xg-slider class="royplayer-slider" tabindex="2">
                                                    <xg-bar class="royplayer-bar">
                                                        <xg-drag class="royplayer-drag"></xg-drag>
                                                    </xg-bar>
                                                </xg-slider>`,
  {}, 'royplayer-volume'); let root = player.controls
  root.appendChild(container)
  let containerHeight
  let slider = container.querySelector('.royplayer-slider')
  let bar = container.querySelector('.royplayer-bar')
  let selected = container.querySelector('.royplayer-drag')
  let icon = container.querySelector('.royplayer-icon')
  ...
  icon.addEventListener('mouseenter', (e) => {
    e.preventDefault()
    e.stopPropagation()
    util.addClass(player.root, 'royplayer-volume-active')
    container.focus()
  })
  ...
  container.addEventListener('blur', (e) => {
    e.preventDefault()
    e.stopPropagation()
    util.removeClass(player.root, 'royplayer-volume-active')
  })
