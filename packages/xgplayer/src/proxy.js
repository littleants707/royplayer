...
class Proxy {
  ...
  set src (url) {
    let self = this
    if (!util.hasClass(this.root, 'royplayer-ended')) {
  ...
  get fullscreen () {
    return util.hasClass(this.root, 'royplayer-is-fullscreen') || util.hasClass(this.root, 'royplayer-fullscreen-active')
  }
  get bullet () {
    return util.findDom(this.root, 'xg-bullet') ? util.hasClass(util.findDom(this.root, 'xg-bullet'), 'royplayer-has-bullet') : false
  }
  get textTrack () {
    return util.hasClass(this.root, 'royplayer-is-textTrack')
  }
  get pip () {
    return util.hasClass(this.root, 'royplayer-pip-active')
  }
}
